...
module MenhirBasics = struct
  ...
  type token = 
    | WORD of (
# 4 "opam/merlin/src/sherlodoc/type_parser.mly"
      (string)
# 15 "opam/merlin/src/sherlodoc/type_parser.ml"
  )
    | WILDCARD
    | STAR
    | POLY of (
# 5 "opam/merlin/src/sherlodoc/type_parser.mly"
      (string)
# 22 "opam/merlin/src/sherlodoc/type_parser.ml"
  )
    | PARENS_OPEN
    | PARENS_CLOSE
    | EOF
...
# 4 "opam/merlin/src/sherlodoc/type_parser.mly"
      (string)
# 90 "opam/merlin/src/sherlodoc/type_parser.ml"
)
...
# 4 "opam/merlin/src/sherlodoc/type_parser.mly"
      (string)
# 97 "opam/merlin/src/sherlodoc/type_parser.ml"
)
...
# 216 "<standard.mly>"
    ( [] )
# 108 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (string list))
...
# 219 "<standard.mly>"
    ( x :: xs )
# 116 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (string list))

let _menhir_action_03 =
  fun x ->
    (
# 49 "opam/merlin/src/sherlodoc/type_parser.mly"
           ( [x] )
# 124 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t list))

let _menhir_action_04 =
  fun x xs ->
    (
# 50 "opam/merlin/src/sherlodoc/type_parser.mly"
                                               ( x::xs )
# 132 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t list))
...
# 49 "opam/merlin/src/sherlodoc/type_parser.mly"
           ( [x] )
# 140 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t list))
...
# 50 "opam/merlin/src/sherlodoc/type_parser.mly"
                                               ( x::xs )
# 148 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t list))

let _menhir_action_07 =
  fun t ->
    (
# 13 "opam/merlin/src/sherlodoc/type_parser.mly"
              ( t )
# 156 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t))

let _menhir_action_08 =
  fun t ->
    (
# 17 "opam/merlin/src/sherlodoc/type_parser.mly"
           ( t )
# 164 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t))

let _menhir_action_09 =
  fun a b ->
    (
# 18 "opam/merlin/src/sherlodoc/type_parser.mly"
                       ( Type_parsed.Arrow (a, b) )
# 172 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t))

let _menhir_action_10 =
  fun () ->
    (
# 36 "opam/merlin/src/sherlodoc/type_parser.mly"
             ( Type_parsed.Wildcard )
# 180 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t))

let _menhir_action_11 =
  fun w ->
    (
# 37 "opam/merlin/src/sherlodoc/type_parser.mly"
           ( Type_parsed.Tyvar w )
# 188 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t))

let _menhir_action_12 =
  fun w ->
    (
# 38 "opam/merlin/src/sherlodoc/type_parser.mly"
           ( Type_parsed.Tycon (w, []) )
# 196 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t))

let _menhir_action_13 =
  fun () ->
    (
# 26 "opam/merlin/src/sherlodoc/type_parser.mly"
    ( Type_parsed.Wildcard )
# 204 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t))

let _menhir_action_14 =
  fun ts ->
    (
# 27 "opam/merlin/src/sherlodoc/type_parser.mly"
            ( Type_parsed.tuple ts )
# 212 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t))

let _menhir_action_15 =
  fun ts w ws ->
    (
# 29 "opam/merlin/src/sherlodoc/type_parser.mly"
    (
      List.fold_left ( fun acc w ->
	  Type_parsed.Tycon (w, [acc])) (Type_parsed.Tycon (w, ts)) ws
    )
# 223 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t))

let _menhir_action_16 =
  fun xs ->
    (
# 22 "opam/merlin/src/sherlodoc/type_parser.mly"
                         ( Type_parsed.tuple xs )
# 231 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t))

let _menhir_action_17 =
  fun t ->
    (
# 43 "opam/merlin/src/sherlodoc/type_parser.mly"
           ( [t] )
# 239 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t list))

let _menhir_action_18 =
  fun ts ->
    (
# 44 "opam/merlin/src/sherlodoc/type_parser.mly"
                                                  ( ts )
# 247 "opam/merlin/src/sherlodoc/type_parser.ml"
     : (Type_parsed.t list))
